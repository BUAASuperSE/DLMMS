...
|2.1|用户可以查找上传的深度学习网络模型|用户应该输入查找的模型信息|UB|
|2.2|用户可以查找上传的深度学习网络模型|如果用户输入的内容不符合要求，那么系统将显示“请输入正确格式”|UW|
|2.3|用户可以查找上传的深度学习网络模型|如果系统未能查询到相应的模型，那么系统将显示“未找到匹配项目”|UW|
|3.1|用户可以删除已上传的深度学习网络模型|用户应该选择想要删除的模型，并点击删除按键|UB|
|3.2|用户可以删除已上传的深度学习网络模型|如果未能成功删除模型，那么系统将显示“删除模型失败”|UW|
|4.1|用户可以管理深度学习网络模型版本|用户应该选择想要修改的模型，并点击修改按键|UB|
|4.2|用户可以管理深度学习网络模型版本|当用户点击修改按键时，系统将展示模型现有版本以及新的版本修改框|EV|
|4.3|用户可以管理深度学习网络模型版本|用户应该输入新的版本信息进行修改|UB|
|4.4|用户可以管理深度学习网络模型版本|如果未能成功修改模型版本信息，那么系统将显示“修改模型失败”|UW|
|5.1|用户可以下载已上传的深度学习网络模型|用户应该选择需要下载的深度学习网络模型，并进行下载|UB|
|5.2|用户可以下载已上传的深度学习网络模型|如果未能成功下载模型，那么系统将显示“下载模型失败”|UW|
|6.1|用户可以部署已上传的深度学习网络模型，以便对外提供服务|用户应该选择需要部署的网络模型，并进行部署|UB|
|6.2|用户可以部署已上传的深度学习网络模型，以便对外提供服务|如果未能成功部署模型，那么系统将显示“模型部署失败”|UW|
|7.1|用户可以下线已部署的深度学习网络模型|用户应该选择需要下线的已部署模型，并进行下线|UB|
|7.2|用户可以下线已部署的深度学习网络模型|如果未能成功下线已部署模型，那么系统将显示“下线模型失败”|UW|
|8.1|用户可以查找已部署的深度学习网络模型|用户应该输入想要查找的已部署的模型信息|UB|
|8.2|用户可以查找已部署的深度学习网络模型|如果用户输入的模型未部署，那么系统将显示“该模型尚未部署”|UW|
|8.3|用户可以查找已部署的深度学习网络模型|如果系统未能查询到相应的模型，那么系统将显示“未找到匹配项目”|UW|
