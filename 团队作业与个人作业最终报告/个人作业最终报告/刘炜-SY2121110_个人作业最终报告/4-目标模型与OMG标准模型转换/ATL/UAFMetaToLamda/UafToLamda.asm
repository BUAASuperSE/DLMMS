...
<asm version="1.0" name="0">
	<cp>
		...
		<constant value="ResourcePerformer"/>
		<constant value="s"/>
		<constant value="IN"/>
		<constant value="MMOF!Classifier;.allInstancesFrom(S):QJ"/>
		<constant value="ResourceAsset"/>
		<constant value="SafeName"/>
		<constant value="3"/>
		...
		<constant value="Ms!ResourcePerformer;"/>
		<constant value="ag"/>
		<constant value="AgentName"/>
		...
		<constant value="Ms!ResourceAsset;"/>
		<constant value="SafeNode"/>
		<constant value="assname"/>
		<constant value="safe"/>
	...
	<operation name="65">
		...
		<linenumbertable>
			...
			<lne id="87" begin="26" end="26"/>
			<lne id="88" begin="25" end="27"/>
			<lne id="89" begin="23" end="29"/>
			<lne id="90" begin="32" end="32"/>
			<lne id="91" begin="33" end="33"/>
			<lne id="92" begin="32" end="34"/>
			<lne id="93" begin="30" end="36"/>
			<lne id="94" begin="39" end="39"/>
			<lne id="95" begin="40" end="40"/>
			<lne id="96" begin="39" end="41"/>
			<lne id="97" begin="37" end="43"/>
			<lne id="98" begin="46" end="46"/>
			<lne id="99" begin="47" end="47"/>
			<lne id="100" begin="46" end="48"/>
			<lne id="101" begin="44" end="50"/>
			<lne id="102" begin="53" end="53"/>
			<lne id="103" begin="54" end="54"/>
			<lne id="104" begin="53" end="55"/>
			<lne id="105" begin="51" end="57"/>
			<lne id="106" begin="60" end="60"/>
			<lne id="107" begin="61" end="61"/>
			<lne id="108" begin="60" end="62"/>
			<lne id="109" begin="58" end="64"/>
			<lne id="110" begin="67" end="67"/>
			<lne id="111" begin="68" end="68"/>
			<lne id="112" begin="67" end="69"/>
			<lne id="113" begin="65" end="71"/>
		...
		<localvariabletable>
			...
			<lve slot="1" name="114" begin="0" end="72"/>
		</localvariabletable>
	</operation>
	<operation name="115">
		<context type="6"/>
		<parameters>
			<parameter name="19" type="116"/>
		</parameters>
		<code>
			<getasm/>
			<get arg="1"/>
		...
		<linenumbertable>
			<lne id="120" begin="25" end="25"/>
			<lne id="121" begin="25" end="26"/>
			<lne id="122" begin="23" end="28"/>
			<lne id="123" begin="22" end="29"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="2" name="117" begin="18" end="30"/>
	...
	<operation name="124">
		...
		<localvariabletable>
			<lve slot="2" name="76" begin="18" end="30"/>
			<lve slot="0" name="17" begin="0" end="30"/>
	...
	<operation name="133">
		...
		<localvariabletable>
			<lve slot="2" name="78" begin="18" end="30"/>
			<lve slot="0" name="17" begin="0" end="30"/>
