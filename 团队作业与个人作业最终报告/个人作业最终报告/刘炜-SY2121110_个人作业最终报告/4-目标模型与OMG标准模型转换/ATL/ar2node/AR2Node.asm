...
<asm version="1.0" name="0">
	<cp>
		...
		<constant value="ActualResource"/>
		<constant value="s"/>
		<constant value="IN"/>
		<constant value="MMOF!Classifier;.allInstancesFrom(S):QJ"/>
		<constant value="ActualControl"/>
		<constant value="ActualManage"/>
		<constant value="3"/>
		...
		<constant value="Ms!ActualResource;"/>
		<constant value="ag"/>
		<constant value="AgentName"/>
		...
		<constant value="Ms!ActualControl;"/>
		<constant value="SafeNode"/>
		...
		<constant value="Ms!ActualManage;"/>
		<constant value="FileNode"/>
		<constant value="amname"/>
		<constant value="file"/>
